...
class WorkingHours extends Model{
    ...
    function getExitTime(){
        ...
        $setDefaultBreakInterval = DateInterval::createFromDateString('1 hour');

        if(!$t1){
            return (new DateTimeImmutable())->add($workDay)->add($setDefaultBreakInterval);
            // aqui o usuário n tem nem o primeiro ponto batido
        }else if($t4){
            return $t4;
        }else{
